	...
	<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="560" style="background:#FDFAF4;border-radius:14px;padding:32px">
		<tr>
			<td>
				...
				<h2 style="font-family:Georgia,serif;font-weight:400;font-size:24px;color:#354535;margin:0 0 12px">Verify your email address.</h2>
				<p style="margin:0 0 18px;line-height:1.6;color:#2A2A2A">
					Hello <?php echo esc_html( $user->display_name ); ?>, please confirm your email address to activate your Amida Research account.
				</p>

				<div style="text-align:center;margin:28px 0">
					<a href="<?php echo esc_url( $verify_url ); ?>" style="display:inline-block;background:#354535;color:#F5F0E8;font-family:Arial,Helvetica,sans-serif;font-size:11px;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;padding:0 28px;line-height:52px;border-radius:8px">Verify Email Address</a>
				</div>

				<p style="margin:0 0 18px;font-size:13px;line-height:1.6;color:#8B7355">
					This link expires in 24 hours. If you did not create an account, you may safely ignore this email.
				</p>
				...
				<div style="margin-top:24px;padding:16px;background:rgba(193,125,60,.08);border-left:3px solid #C17D3C;border-radius:8px;font-size:13px;line-height:1.6;color:#8B7355">
					...
					Amida supplies research chemicals for laboratory and institutional use only. By verifying your account you reaffirm that you are 21+ and a qualified researcher.
				</div>
