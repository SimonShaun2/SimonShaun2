 ...
 * @var WP_User $user
 * @var string  $reset_url  One-time password reset link.
 */
	...
	<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="560" style="background:#FDFAF4;border-radius:14px;padding:32px">
		<tr>
			<td>
				...
				<h2 style="font-family:Georgia,serif;font-weight:400;font-size:24px;color:#354535;margin:0 0 12px">Reset your password.</h2>
				<p style="margin:0 0 18px;line-height:1.6;color:#2A2A2A">
					Hello <?php echo esc_html( $user->display_name ); ?>, a password reset was requested for your Amida Research account.
				</p>

				<div style="text-align:center;margin:28px 0">
					<a href="<?php echo esc_url( $reset_url ); ?>" style="display:inline-block;background:#354535;color:#F5F0E8;font-family:Arial,Helvetica,sans-serif;font-size:11px;letter-spacing:.14em;text-transform:uppercase;text-decoration:none;padding:0 28px;line-height:52px;border-radius:8px">Reset Password</a>
				</div>

				<p style="margin:0 0 18px;font-size:13px;line-height:1.6;color:#8B7355">
					This link expires in 1 hour. If you did not request a password reset, your account credentials remain unchanged — no action is needed.
				</p>
